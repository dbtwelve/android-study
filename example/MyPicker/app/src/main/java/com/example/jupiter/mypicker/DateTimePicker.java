...
public class DateTimePicker extends LinearLayout {
    ...
    OnDateTimeChangeListner listener;
    ...
    private void init(Context context) {
        ...
        datePicker.init(curYear, curMonth, curDay, new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker datePicker, int year, int month, int date) {
                if (listener != null) {
                    listener.onDateTimeChange(DateTimePicker.this, year, month, date, timePicker.getCurrentHour(), timePicker.getCurrentMinute());
                }
            }
        });
    ...
    public void setOnDateTimeChangeListener(OnDateTimeChangeListner listener) {
        this.listener = listener;
    }


    public void updateDateTime(int year, int month, int date, int hour, int minute) {
